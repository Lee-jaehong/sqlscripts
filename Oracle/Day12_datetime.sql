...
-- 날짜형식은 문자열 'yyyy-MM-dd' 와 자동캐스팅이 됩니다.
INSERT INTO tbl_date(acol,ccol)
VALUES ('2022-10-11','2022-10-12');		-- DATE, timestamp 차이가 없습니다.

-- 내일 시험에서 timestamp 타입으 date 타입과 똑같이 코딩하면 됩니다.
-- date와 timestamp 모두 to_char 함수는 동일하게 사용가능

SELECT TO_CHAR(TO_DATE('20210301', 'YYYYMMDD'), 'YYYY-MM-DD') FROM DUAL;
