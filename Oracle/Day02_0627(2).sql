...
INSERT INTO tbl_string(acol) values('가나다라');	-- 오류: 열에 대한 값이 너무 큼(실제:12, 최대:10)
INSERT INTO tbl_string(acol) values('가나');		-- 공백 4개 추가

-- varchar2 타입 : bcol은 가변길이 10바이트
INSERT INTO tbl_string(bcol) values('abcdefghij');
INSERT INTO tbl_string(bcol) values('abcdef');		-- bcol은 가변길이 타입
INSERT INTO tbl_string(bcol) values('abcdefghijklm');	-- 오류 : 길이 초과
-- INSERT 확인
SELECT * FROM tbl_string;
-- 한글 확인
INSERT INTO tbl_string(bcol) values('가나다');	-- 
INSERT INTO tbl_string(bcol) values('가나다라');	-- 오류: 열에 대한 값이 너무 큼(실제:12, 최대:10)
INSERT INTO tbl_string(bcol) values('가나');		-- 

-- char과 varchar2는 바이트 단위. nchar과 nvarchar2는 문자개수 단위(다국어 문자가 많이 포함되는 컬럼에 적절)
-- nchar 타입
