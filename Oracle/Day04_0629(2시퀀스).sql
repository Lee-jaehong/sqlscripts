...
INSERT INTO tbl_seq VALUES (test_seq1.nextval, '모모');
INSERT INTO tbl_seq VALUES (test_seq1.nextval, '쯔위');
INSERT INTO tbl_seq VALUES (test_seq1.nextval, '나연');
INSERT INTO tbl_seq VALUES (test_seq1.nextval, '다현');
INSERT INTO tbl_seq VALUES (test_seq1.nextval, '지효');
SELECT * FROM tbl_seq;

CREATE SEQUENCE test_seq2 
	INCREMENT BY 2 		-- 증감 설정
	START WITH 20001;	-- 시작값		-- MAXVALUE는 최대값
									-- MINVALUE는 최대값 도달후 순환하는 최소값
